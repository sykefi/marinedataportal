export default {
    ...
    $veslaInfo: 'Tiedot ovat saatavissa yksityiskohtaisemmin SYKEn <a target="_blank" rel="noopener" href="https://www.syke.fi/fi-FI/Avoin_tieto/Ymparistotietojarjestelmat">Avoin tieto -palvelusta</a>.',
};
